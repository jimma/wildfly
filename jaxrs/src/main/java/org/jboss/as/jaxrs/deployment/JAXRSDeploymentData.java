 ...
 */
public class JAXRSDeploymentData {
     ...
     */
    public void merge(final List<JAXRSDeploymentData> deploymentData) throws DeploymentUnitProcessingException {
        for (JAXRSDeploymentData data : deploymentData) {
