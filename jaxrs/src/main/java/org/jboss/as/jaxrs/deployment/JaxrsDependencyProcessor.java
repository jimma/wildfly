 ...
 *
 * TODO!! revisit to add only the really needed stuff (likely nothing, the jaxrs api module will need to act as the jaxws one,
 * basically being able to pull cxf without exposing it by default).
 *
 * @author Stuart Douglas
 */
public class JaxrsDependencyProcessor implements DeploymentUnitProcessor {

    // public static final ModuleIdentifier RESTEASY_ATOM =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-atom-provider");
    ...
    // public static final ModuleIdentifier RESTEASY_VALIDATOR_11 =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-validator-provider-11");
    // public static final ModuleIdentifier RESTEASY_JAXRS = ModuleIdentifier.create("org.jboss.resteasy.resteasy-jaxrs");
    // public static final ModuleIdentifier RESTEASY_JAXB =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-jaxb-provider");
    // public static final ModuleIdentifier RESTEASY_JACKSON2 =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-jackson2-provider");
    // public static final ModuleIdentifier RESTEASY_JSON_P_PROVIDER =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-json-p-provider");
    // public static final ModuleIdentifier RESTEASY_JETTISON =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-jettison-provider");
    // public static final ModuleIdentifier RESTEASY_JSAPI = ModuleIdentifier.create("org.jboss.resteasy.resteasy-jsapi");
    // public static final ModuleIdentifier RESTEASY_MULTIPART =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-multipart-provider");
    // public static final ModuleIdentifier RESTEASY_YAML =
    // ModuleIdentifier.create("org.jboss.resteasy.resteasy-yaml-provider");
    ...
    /**
     * We include this so that jackson annotations will be available, otherwise they will be ignored which leads to confusing
     * behaviour.
     *
     */
    ...
    private void addDependency(ModuleSpecification moduleSpecification, ModuleLoader moduleLoader,
        ...
        moduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, moduleIdentifier, optional, false, true,
                false));
    }
