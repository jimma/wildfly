...
public final class ServletDelegateFactoryImpl implements ServletDelegateFactory {
    ...
    public ServletDelegate newServletDelegate(final String servletClassName) {
        final JAXRSClassLoaderProvider provider = JAXRSClassLoaderProvider.getDefaultProvider();
        try {
            ...
            throw JaxrsLogger.JAXRS_LOGGER.cannotInstantiateServletDelegate(e, servletClassName);
        }
    }
