...
public final class EndpointPublisherImpl implements EndpointPublisher {
   ...
   private WebHost host;
    ...
    private synchronized List<DeploymentAspect> getReplacedDeploymentAspects() {
        if (depAspects == null) {
    ...
    private synchronized List<DeploymentAspect> getPublisherDeploymentAspects() {
    ...
    class ForceJAXWSInVocationHandlerDeploymentAspect extends AbstractDeploymentAspect {
